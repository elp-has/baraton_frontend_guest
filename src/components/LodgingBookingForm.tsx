...
const LodgingBookingForm: React.FC<LodgingBookingFormProps> = ({ lodgingId, roomName }) => {
    ...
    <div className="grid grid-cols-1 gap-4 text-sm animate-fade-in">
      ...
      <div>
        ...
        <div className="flex items-start border rounded-md px-3 py-2">
          ...
          <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="e.g. Require extra towels or early check-in" className="border-0 p-0 focus-visible:ring-0 resize-none" />
        </div>
      </div>
